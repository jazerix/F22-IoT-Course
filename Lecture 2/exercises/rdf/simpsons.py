...
g.add((maggie, hasName, Literal('Maggie')))
g.add((maggie, RDF.type, Female))

g.add((marge, hasName, Literal('Marge')))
g.add((marge, RDF.type, Female))
g.add((marge, parentOf, maggie))
g.add((marge, parentOf, bart))
g.add((marge, parentOf, lisa))

g.add((lisa, hasName, Literal('Lisa')))
g.add((lisa, RDF.type, Female))
g.add((lisa, olderThan, maggie))

g.add((bart, hasName, Literal('Bart')))
g.add((bart, RDF.type, Male))
g.add((bart, olderThan, lisa))
g.add((bart, olderThan, maggie))

g.add((homer, hasName, Literal('Homer')))
g.add((homer, RDF.type, Male))
g.add((homer, parentOf, maggie))
g.add((homer, parentOf, bart))
g.add((homer, parentOf, lisa))
g.add((homer, olderThan, marge))
